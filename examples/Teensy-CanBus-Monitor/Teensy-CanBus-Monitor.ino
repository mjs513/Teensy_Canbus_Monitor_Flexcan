...
void setup() {
  ...
  Serial.println("WELCOME TO TEENSY CANBUS MONITOR BASED ON CAN-232");
  Can232::init(CAN_1000KBPS); // set default rate you need here and clock frequency of CAN shield. Typically it is 16MHz, but on some MCP2515 + TJA1050 it is 8Mhz
