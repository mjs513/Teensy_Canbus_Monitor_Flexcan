...
#define LW232_CMD_CUSTOM    '.' //   custom to turn MB details on/off 
...
#define LW232_DEFAULT_CAN_RATE         CAN_1000KBPS
...
{
public:
    static void init(INT32U defaultCanSpeed = LW232_DEFAULT_CAN_RATE);
